        ...
        <div class="how-it-works">
            ...
            <div class="steps-container">
                ...
                <div class="step">
                    <h3>4. Book & Contact Fixer</h3>
                    <p>Book the service that fits your schedule through our platform. Our system ensures transparent pricing with no hidden fees.</p>
                </div>
                <div class="step">
                    <h3>5. Get the Job Done</h3>
                    <p>Your chosen fixer will arrive at the scheduled time. Add a review from the service to let other people know!</p>
                </div>
            </div>
        </div>